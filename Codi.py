...
Classes_estel·lars = pd.read_csv('C:\\Users\\MohamedAmriDoudouh\\Downloads\\Stellar_classes.csv') #Entre les parèntesis cal que es posi la direcció de la taula Stellar_classes
...
while len(linies[linies['line_type'] == 'absorption']) >= 30:
    ...
    with warnings.catch_warnings():
         warnings.simplefilter('ignore')
         linies = find_lines_derivative(Espectre_normalitzat, flux_threshold= n)
LiniesÀtoms = read_csv('C:\\Users\\MohamedAmriDoudouh\\Desktop\\Tdr\\ElementsTDR.csv') # Entre les parèntesis cal que es posi la direcció de la taula ElementsTDR
